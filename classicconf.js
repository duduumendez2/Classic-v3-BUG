...
//==========================zetsuboclient=======================//
global.botname = '⫹★彡[𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙 V3]彡★⫺' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.packname = '⫹★彡[𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙 V3]彡★⫺' // ubah aja ini nama sticker
global.author = '༻࿇𝐊𝐈𝐍𝐆_𝐒𝐀𝐌 WITH MENDEZ❖༺' // ubah aja ini nama sticker
global.prefa = ['','!','.',',','🐤','🗿']
